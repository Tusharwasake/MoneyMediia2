...
//   const fetchTestimonials = async (useFeatured: boolean = true) => {
//     try {
//       setIsLoading(true);
//       setError(null);
...
//       // Only set empty state if we don't have any data
...
//         }
//         .gradient-border {
//           background: linear-gradient(45deg, #059669, #0d9488, #3b82f6);
//         }
//         .perspective-1000 {
//           perspective: 1000px;
//         }
