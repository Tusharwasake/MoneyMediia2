...
//               Let's discuss how Money Mediia can help you create engaging financial content that resonates with your audience and drives results.
//             </p>
...
//               <div className="absolute -top-6 -left-6 w-40 h-40 bg-money-green/20 rounded-full filter blur-xl"></div>
//               <div className="absolute -bottom-8 -right-8 w-64 h-64 bg-money-teal/20 rounded-full filter blur-xl"></div>
//               <img
//                 src="https://placehold.it/600x400?text=Financial+Content"
