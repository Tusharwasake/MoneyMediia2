...
const PortfolioBlogs = () => {
  ...
  const industries = [
    "all",
    ...Array.from(new Set(blogs.map((blog) => blog.industry).filter(Boolean))),
  ];
            ...
            <div className="flex flex-col items-center justify-center min-h-[400px]">
              <div className="text-center">
                ...
                <p className="text-gray-500">
                  Please wait while we prepare our financial insights
                </p>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div className="text-center mb-12 max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-gray-900 via-green-800 to-teal-700 bg-clip-text text-transparent">
              Financial Blog & Insights
            </h1>

            <p className="text-xl text-gray-600 mx-auto">
              Expert insights, educational resources, and thought leadership on
              financial topics to help you make informed decisions.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              {filteredBlogs.map((blog, index) => (
                <div
                  ...
                  className={`group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 opacity-0 animate-in border border-gray-100 flex flex-col h-full`}
                  style={{ animationDelay: `${index * 0.1}s` }}
                  onMouseEnter={() => setHoveredBlog(blog._id || blog.id)}
                ...
                >
                  ...
                  <div className="aspect-video relative overflow-hidden">
                    ...
                    {/* Date badge on the bottom edge */}
                    <div className="absolute bottom-4 right-4 bg-white/20 backdrop-blur-md text-white px-3 py-1 text-xs rounded-full shadow-md flex items-center gap-1">
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <p className="text-gray-600 text-sm mb-6 flex-grow line-clamp-3">
                      {blog.excerpt ||
                        blog.description ||
                        "This article explores important financial concepts and strategies for informed decision-making."}
                    </p>
              ...
              <div className="relative z-10 md:flex items-center justify-between">
                <div className="md:max-w-xl mb-8 md:mb-0">
                  ...
                  <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 drop-shadow-md">
                    Need Custom Financial Content for Your Brand?
                  </h3>

                  <p className="text-white/90 md:pr-6 mb-6">
                    Our expert team can create engaging, informative financial
                    content tailored to your audience and brand voice.
                  </p>
                ...
                <div className="hidden lg:block w-80 h-80 relative">
                  <div className="absolute inset-0 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 shadow-xl overflow-hidden">
                    <div className="h-10 bg-white/10 flex items-center gap-2 px-4">
                    ...
                    <div className="p-6">
                      <div className="h-4 w-3/4 bg-white/20 rounded-full mb-4"></div>
                      <div className="h-4 w-full bg-white/20 rounded-full mb-4"></div>
                      <div className="h-4 w-5/6 bg-white/20 rounded-full mb-8"></div>

                      <div className="h-4 w-full bg-white/15 rounded-full mb-3"></div>
                      <div className="h-4 w-full bg-white/15 rounded-full mb-3"></div>
                      <div className="h-4 w-4/5 bg-white/15 rounded-full mb-8"></div>

                      <div className="h-4 w-full bg-white/10 rounded-full mb-3"></div>
                      <div className="h-4 w-full bg-white/10 rounded-full mb-3"></div>
                      <div className="h-4 w-2/3 bg-white/10 rounded-full mb-3"></div>
                    </div>
                  </div>
                </div>
              </div>
